...
A seller needs full Etsy + Shopify listing copy for this niche/product.

Niche: "{keyword}"
Product ideas: {products}
Design angles: {angles}

Generate optimized listing copy. Etsy SEO rules:
- Title: 140 chars max, start with the most searched keyword, use | or , as separators, include gift angle
- Tags: Exactly 13 tags, each max 20 chars, long-tail keywords buyers actually search, NO duplicate words across tags
- Description: Hook buyers in the first 2 sentences (visible before "read more"), mention: the niche, gifting occasion, customization hint
- Shopify meta: 155 chars max, include primary keyword, focus on buyer intent
